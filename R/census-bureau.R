...
#' \href{https://cran.r-project.org/web/packages/sf/index.html}{sf package}. They are intended
...
#'   boundaries for the 119th Congress, 1:500k resolution.}
#'   \item{congress_contemporary_lores}{Congressional district boundaries for
#'   the 119th Congress, 1:20m resolution.}
...
#'    Boundary Shapefiles} (2024).
#'
#'   See the U.S. Census Bureau's
#'   "\href{https://www.census.gov/programs-surveys/geography/guidance/geo-identifiers.html}{Understanding
#'    Geographic Identifiers (GEOIDs)}" and their
#'   "\href{https://www.census.gov/programs-surveys/geography/technical-documentation/code-lists.html}{Geographic
